...
.. figure:: ../../../../../nrf/app_dev/optimizing/images/app_power_opt_blinky_serial_on.png
   :width: 100 %
...
.. figure:: ../../../../../nrf/app_dev/optimizing/images/app_power_opt_blink_serial_off.png
   :width: 100 %
...
1. Start the simulation in Online Power Profiler with the default settings and add the following changes to the default configuration:
   ...
   #. In the **Data transfer** section on the left, select :guilabel:`Upload` from the **Enable** drop-down menu. The **Data size (bytes)** and **Data transfer interval (sec)** options are now visible. Set the options to the following values:
	...
	.. figure:: ../../../../../nrf/app_dev/optimizing/images/app_power_opt_opp_default_20byte_10min.png
	   :width: 100 %
...
#. Tune the current estimation:
	...
	.. figure:: ../../../../../nrf/app_dev/optimizing/images/app_power_opt_opp_default_40_byte_20min.png
	   :width: 100 %
...
#. If PSM is available in your network, the power measurement using Power Profiler Kit II produces the following results:
   ...
   .. figure:: ../../../../../nrf/app_dev/optimizing/images/app_power_opt_ppk_psm.png
      :width: 100 %
...
#. A 40-byte data packet is now sent every two minutes. Make sure that the frequency is sufficiently higher than the duration of RRC inactivity present in the network.
   ...
   .. figure:: ../../../../../nrf/app_dev/optimizing/images/app_power_opt_ppk_40_byte.png
      :width: 100 %
...
#. Rebuild and program the sample.
   ...
   .. figure:: ../../../../../nrf/app_dev/optimizing/images/app_power_opt_ppk_120_byte.png
      :width: 100 %
...
1. Measure the RRC inactivity timer value using Power Profiler Kit II.
   ...
   .. figure:: ../../../../../nrf/app_dev/optimizing/images/app_power_opt_ppk_inactivity_timer.png
      :width: 100 %
   ...
   .. figure:: ../../../../../nrf/app_dev/optimizing/images/app_power_opt_ppk_cdrx_interval.png
      :width: 100 %
   ...
   .. figure:: ../../../../../nrf/app_dev/optimizing/images/app_power_opt_ppk_cdrx_duration_40ms.png
      :width: 100 %
...
#. Provide the measurements from the previous step to Online Power Profiler:
   ...
   .. figure:: ../../../../../nrf/app_dev/optimizing/images/app_power_opt_opp_tuned_with_measurements.png
      :width: 100 %
   ...
   .. figure:: ../../../../../nrf/app_dev/optimizing/images/app_power_opp_cdrx_normal.png
      :width: 100 %
      :alt: Normal cDRX
   ...
   .. figure:: ../../../../../nrf/app_dev/optimizing/images/app_power_opt_drx_long.png
      :width: 100 %
      :alt: Long cDRX
...
.. figure:: ../../../../../nrf/app_dev/optimizing/images/app_power_opt_ppk_10sec_active_timer.png
   :width: 100 %
