...
#. Prepare the Thingy:91 hardware:
   ...
   #. Power the Thingy:91 on by switching **SW1** to the **ON** position.
      ...
      .. figure:: ../../../../../nrf/working_with_nrf/nrf91/images/thingy91_pwr_switch.svg
...
.. tabs::
   ...
   .. group-tab:: Through USB
      ...
      #. Scroll down in the menu on the left and make sure **Enable MCUboot** is selected.
         ...
         .. figure:: ../../../../../nrf/working_with_nrf/nrf91/images/programmer_enable_mcuboot.png
      ...
      #. Press **SW4** while switching **SW1** to the **ON** position.
         ...
         .. figure:: ../../../../../nrf/working_with_nrf/nrf91/images/thingy91_sw1_sw4.svg
      ...
      #. In the Programmer navigation bar, click :guilabel:`SELECT DEVICE`.
         ...
         .. figure:: ../../../../../nrf/working_with_nrf/nrf91/images/programmer_select_device2.png
      ...
      #. In the menu on the left, click :guilabel:`Add file` in the **FILE** section, and select :guilabel:`Browse`.
         ...
         .. figure:: ../../../../../nrf/working_with_nrf/nrf91/images/programmer_add_file2.png
      ...
      #. Scroll down in the menu on the left to the **DEVICE** section and click :guilabel:`Write`.
         ...
         .. figure:: ../../../../../nrf/working_with_nrf/nrf91/images/programmer_hex_write1.png
         ...
         .. figure:: ../../../../../nrf/working_with_nrf/nrf91/images/thingy91_mcuboot_dfu.png
   ...
   .. group-tab:: Through external debug probe
      ...
      2. Prepare the hardware:
         ...
         a. Connect the Thingy:91 to the debug out port on a 10-pin external debug probe using a JTAG cable.
            ...
            .. figure:: ../../../../../nrf/working_with_nrf/nrf91/images/programmer_thingy91_connect_dk_swd_vddio.svg
         ...
         #. Connect the external debug probe to the computer with a micro-USB cable.
            ...
            .. figure:: ../../../../../nrf/working_with_nrf/nrf52/images/programmer_select_device1.png
               :alt: Programmer - Select device
         ...
         #. Click :guilabel:`SELECT DEVICE` and select the appropriate debug probe entry from the drop-down list.
            ...
            .. figure:: ../../../../../nrf/working_with_nrf/nrf91/images/programmer_com_ports.png
      ...
      #. In the menu on the left, click :guilabel:`Add file` in the **FILE** section, and select :guilabel:`Browse`.
         ...
         .. figure:: ../../../../../nrf/working_with_nrf/nrf91/images/programmer_add_file1.png
            :alt: Programmer - Add file
      ...
      #. Scroll down in the menu on the left to the **DEVICE** section and click :guilabel:`Erase & write`.
         ...
         .. figure:: ../../../../../nrf/working_with_nrf/nrf91/images/programmer_ext_debug_hex_write.png
...
.. tabs::
   ...
   .. group-tab:: Through USB
     ...
     To update the modem firmware using USB, complete the following steps:
      ...
      #. Press **SW3** while switching **SW1** to the **ON** position.
         ...
         .. figure:: ../../../../../nrf/working_with_nrf/nrf91/images/thingy91_sw1_sw3.svg
      ...
      #. In the menu on the left, click :guilabel:`Add file` in the **FILE** section, and select :guilabel:`Browse`.
         ...
         .. figure:: ../../../../../nrf/working_with_nrf/nrf91/images/programmer_add_file.png
            :alt: Programmer - Add file
      ...
      8. In the Programmer app, scroll down in the menu on the left to the **DEVICE** section and click :guilabel:`Write`.
         ...
         .. figure:: ../../../../../nrf/working_with_nrf/nrf91/images/programmer_usb_update_modem.png
         ...
         .. figure:: ../../../../../nrf/working_with_nrf/nrf91/images/thingy91_modemdfu_mcuboot.png
   ...
   .. group-tab:: Through external debug probe
      ...
      #. In the Programmer app, scroll down in the menu on the left to the **DEVICE** section and click :guilabel:`Write`.
         ...
         .. figure:: ../../../../../nrf/working_with_nrf/nrf91/images/programmer_ext_debug_update_modem.png
            :alt: Programmer - Update modem
         ...
         .. figure:: ../../../../../nrf/working_with_nrf/nrf91/images/programmer_modemdfu.png
...
.. tabs::
   ...
   .. group-tab:: Through USB
      ...
      #. In the Programmer navigation bar, click :guilabel:`SELECT DEVICE`.
         ...
         .. figure:: ../../../../../nrf/working_with_nrf/nrf91/images/programmer_select_device.png
            :alt: Programmer - Select device
      ...
      #. Scroll down in the menu on the left to the **DEVICE** section and click :guilabel:`Write`.
         ...
         .. figure:: ../../../../../nrf/working_with_nrf/nrf91/images/programmer_hex_write.png
            :alt: Programmer - Writing of HEX files
         ...
         .. figure:: ../../../../../nrf/working_with_nrf/nrf91/images/thingy91_mcuboot_dfu1.png
            :alt: Programmer - MCUboot DFU
...
.. include:: ../../../../../nrf/working_with_nrf/nrf91/nrf9160_gs.rst
...
5. Punch out the nano-SIM from the SIM card and plug it into the SIM card holder on the Thingy:91.
   ...
   .. figure:: ../../../../../nrf/working_with_nrf/nrf91/images/thingy91_insert_sim.svg
      :alt: Inserting SIM
...
#. In the Add LTE Device window from Step 4, enter your device ID and ownership code.
   ...
   .. figure:: ../../../../../nrf/working_with_nrf/nrf91/images/nrfcloud_add_lte_device.png
   ...
   * **Ownership code**: The ownership code is the PIN or the hardware ID of your Thingy:91, and it is found on the label of your Thingy:91.
   ...
   .. figure:: ../../../../../nrf/working_with_nrf/nrf91/images/thingy91_pin_imei.svg
